...
Read individual rule files from `.agents/skills/vercel-react-best-practices/rules/` for detailed explanations and code examples. For the complete compiled guide: `.agents/skills/vercel-react-best-practices/AGENTS.md`.
