...
export function FooterSection() {
  return (
    <footer className="border-t border-border/40 bg-neutral-50">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-12 md:grid-cols-3">
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wider text-foreground/60">Links</h4>
              ...
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <Button
                    ...
                    className="h-auto p-0 text-sm text-foreground/60 transition-colors hover:text-foreground"
                  >
                    {link.label}
                  </Button>
                </li>
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wider text-foreground/60">Legal</h4>
            <ul className="mt-4 space-y-2">
              {legalLinks.map((link) => (
                <li key={link.label}>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border/60 pt-8 sm:flex-row">
          <p className="text-xs text-foreground/60">© 2026 Flowy</p>
          <a
            href="https://forge.ar"
            target="_blank"
          ...
          >
            <span className="text-xs text-foreground/60">Un desarrollo de</span>
            <Image
              src="/forge.png"
              alt="Forge"
              width={56}
